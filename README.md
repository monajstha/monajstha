...
Currently, I am expanding my backend expertise through hands-on projects, focusing on **MERN stack** and **React Native**.

[![](https://img.shields.io/badge/LinkedIn-Connect-blue?style=for-the-badge&logo=linkedin)](https://linkedin.com/in/manojsthaa)
[![](https://img.shields.io/badge/Email-Contact_Me-red?style=for-the-badge&logo=gmail)](mailto:manojstha700@gmail.com)
...
[![](https://img.shields.io/badge/Push_Notifications-ff69b4?style=for-the-badge)](#)  
...
[![](https://img.shields.io/badge/REST_API-ff6347?style=for-the-badge)](#) 
[![](https://img.shields.io/badge/JWT-000000?style=for-the-badge&logo=jsonwebtokens&logoColor=white)](https://jwt.io/) 
...
[![](https://img.shields.io/badge/React_Testing_Library-FF4154?style=for-the-badge)](https://testing-library.com/docs/react-testing-library/intro/)  
...
[![](https://img.shields.io/badge/Trello-0079BF?style=for-the-badge&logo=trello&logoColor=white)](https://trello.com/) 
...
[![](https://img.shields.io/badge/Render-2EC1AC?style=for-the-badge&logo=render&logoColor=white)](https://render.com/) 
...
I am actively deepening my knowledge in **Software Engineering** with a focus on:

* 💻 **Frontend:** Building responsive, dynamic interfaces using **React** and **TypeScript**.
* ⚙️ **Backend:** Architecting RESTful APIs with **Node.js** and **Express**, implementing security best practices.
* 🗄️ **Database:** Managing data integrity with **PostgreSQL** (SQL) and **MongoDB** (NoSQL).
* 🚀 **Deployment:** CI/CD and hosting on platforms like **Render**, **Vercel**, and App Stores.
* 🧪 **Quality:** Writing unit and integration tests to ensure reliability.
